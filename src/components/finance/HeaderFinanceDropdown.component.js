...
export default function HeaderFinanceDropdown({ valueState }){
    ...
    return (
        <>
            <DropDownPicker
                style={{backgroundColor: Constants.colors.gray[100], borderWidth: 0, height: 36, width: 115, paddingTop: 8, paddingBottom: 8, paddingLeft: 12, paddingRight: 12, marginTop: Platform.OS === 'android' ? insets.top + 32 : 32, position: 'absolute', right: 0}}
                dropDownContainerStyle={{backgroundColor: Constants.colors.gray[0], marginTop: Platform.OS === 'android' ? insets.top + 32 : 32, width: 115, borderWidth: 0, borderRadius: 0, elevation: 11, shadowOffset: {width: 0, height: 5}, shadowOpacity: 1, shadowColor: "rgba(0, 0, 0, 0.25)", shadowRadius: 11, overflow: 'visible', position: 'absolute', right: 0}}
