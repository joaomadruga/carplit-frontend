...
export default function ModalOptionsRidersDetails({ modalizeRef, firstText, secondText, actionFirstButton, actionSecondButton, thirdText, actionThirdButton }){
