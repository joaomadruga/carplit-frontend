    ...
    return (
        <SafeAreaViewDefault>
            <PaddingContent>
                    ...
                    <SettingsView onPress={() => navigation.navigate('Passengers')} TextTitle={'Passageiros'} TextSubtitle={'Cadastros das pessoas que dividem o custo da viagem com você'} SourceImage={TeamIcon}/>
